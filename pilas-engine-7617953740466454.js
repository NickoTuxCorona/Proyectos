        ...
        if (recursos === undefined || recursos === null) {
            recursos = {
                ...
                sonidos: [
                    ...
                    {
                        nombre: "gameover_1",
                        ruta: "sonidos/gameover_1.mp3"
                    },
                    {
                        nombre: "mario-bros-hammer-throw",
                        ruta: "sonidos/mario-bros-hammer-throw.mp3"
                    },
                    {
...
var ModoEditor = (function (_super) {
    ...
    ModoEditor.prototype.manejar_evento_key_down = function (evento) {
        if (evento.key === "Meta") {
